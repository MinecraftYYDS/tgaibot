...
# Vendored use-case: package lives under "aiss.ddgs" but internal modules
# still import "ddgs.*". Register a top-level alias for compatibility.
sys.modules.setdefault("ddgs", sys.modules[__name__])
